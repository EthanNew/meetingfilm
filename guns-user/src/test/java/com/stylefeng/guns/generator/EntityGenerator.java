...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\IdeaWorkSpace\\test\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("EthanNew");
        ...
        dsc.setUrl("jdbc:mysql://192.168.5.20:3306/guns_rest?serverTimezone=GMT&useSSL=false&characterEncoding=utf8");
        ...
        pc.setService("com.stylefeng.guns.rest.modular.service");       //本项目没用，生成之后删掉
        pc.setServiceImpl("com.stylefeng.guns.rest.modular.service.impl");   //本项目没用，生成之后删掉
